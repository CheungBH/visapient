            ...
            try:
                ...
                if dis_0_0 < dis_0_1 and dis_1_1 < dis_1_0:
                    ...
                    if dis_0_0 < dis_0_1:
                        ...
                        true_humans[0] = humans[1]
                        true_humans[1] = humans[0]          
                cv2.putText(image,"Label = 0",(int(true_humans[0].body_parts[0].x * width ), int(true_humans[0].body_parts[0].y * height)),  cv2.FONT_HERSHEY_SIMPLEX, 2,(0, 255, 0), 5)            
                cv2.putText(image,"Label = 1",(int(true_humans[1].body_parts[0].x * width ), int(true_humans[1].body_parts[0].y * height)),  cv2.FONT_HERSHEY_SIMPLEX, 2,(0, 255, 0), 5)   
