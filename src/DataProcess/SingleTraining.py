...
_activation='relu'
_optimizer='Adam'
class_names = ["FRight","FWrong","SRight","SWrongHand","UNoTurn","URight","UWrongArm","UWrongFoot","WNoTurn","WPoor","WRight","WWrongFoot"] 
...
model_path = 'model/pose.model'
json_model_path = 'model/pose_model.json'
model_weights_path = "model/pose_model.h5"
...
class TrainingVisualizer(keras.callbacks.History):
    def on_epoch_end(self, epoch, logs={}):
        ...
        #plt.show()
        #plt.savefig('graph/TrainingVisualizer')
        #plt.clf()
        #plt.close()       
...
def plot_confusion_matrix(cm, classes,
    ...
    plt.savefig('graph/Confusion_Matrix')
    plt.close()
