...
_activation='relu'
_optimizer='Adam'
model_weights_path = "RealTime/model/0213_tutorial/golf_tutorial_model5.h5"
...
if __name__ == '__main__':
    ...
    while True:
        ...
        cv2.putText(image,text_display ,(100, 400),  cv2.FONT_HERSHEY_SIMPLEX, 3 ,(255, 255, 255), 3)
        cv2.putText(image,"|" ,(250, 400),  cv2.FONT_HERSHEY_SIMPLEX, 3 ,(255, 255, 255), 3)
